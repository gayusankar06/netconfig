...
async def trigger_analysis(
    ...
    # Trigger Celery job manually
    run_analysis_pipeline_task.delay(str(review_id))
    return {"detail": "Analysis pipeline triggered successfully"}
    ...
    for c in changes:
        if c.risk_level in ["CRITICAL", "HIGH", "MEDIUM"]:
            findings.append({
                ...
                "recommendation": "Review IP restriction settings."
            })
