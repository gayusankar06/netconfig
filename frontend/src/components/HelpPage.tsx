...
import {
  ...
  Button, Chip, Divider, Fade, List, ListItem, ListItemIcon, ListItemText
} from '@mui/material';
...
const FEATURES = [
  {
    ...
    desc: 'Upload Old and New configuration files in JSON, YAML, or plain text (Cisco IOS, Palo Alto). Gemini AI performs deep analysis of every change.'
  },
  {
    icon: <AssessmentIcon />,
    color: '#8B5CF6',
  ...
  },
  {
    ...
    desc: 'Gemini AI evaluates each change for security impact, compliance posture, and business risk. Generates an executive summary with actionable recommendations.'
  },
  {
    icon: <WarningIcon />,
    color: '#F97316',
...
const FAQS = [
  ...
  },
  {
    ...
    a: 'Each detected change is scored 0-100 by our rule engine plus Gemini AI. The highest individual change score becomes the overall review risk level (CRITICAL/HIGH/MEDIUM/LOW). Public internet exposure, credential changes, and sensitive port additions score highest.'
  },
  {
  ...
  },
  {
    ...
    a: 'This means the Celery background worker is running the Gemini AI analysis. This typically takes 10-30 seconds. The page auto-refreshes every 3 seconds while analysis is in progress.'
  },
  {
  ...
  },
  {
    ...
    a: 'Open any completed review (status: pending_review, approved, or rejected). Click the "Download PDF Report" button at the top right. The PDF includes charts, risk evaluation, compliance findings, and AI recommendations.'
  },
  {
      ...
      <Box sx={{ p: { xs: 2, md: 3 }, pb: 8, maxWidth: 1100, mx: 'auto' }}>
        ...
        >
          {[
            ...
            { step: '2', title: 'Submit for Analysis', desc: 'Enter a review title and optional ticket ID. Click Submit & Analyze. Gemini AI starts analyzing in the background (10-30 seconds).', color: '#8B5CF6' },
            ...
            { step: '5', title: 'Download Report', desc: 'Click Download PDF Report to get a complete enterprise report with charts, compliance summary, and AI recommendations.', color: '#06B6D4' },
          ].map((step, i) => (
            <Box key={step.step}>
