...
function RiskGauge({ score, level }: { score: number; level: string }) {
  ...
  return (
    <Box sx={{ textAlign: 'center' }}>
      ...
      <Box sx={{ mt: -6 }}>
        <Typography variant="h2" sx={{ color, fontWeight: 800 }}>{Math.round(score)}</Typography>
        <Chip
          label={level?.toUpperCase() || 'UNKNOWN'}
          sx={{ bgcolor: color, color: 'white', fontWeight: 700, fontSize: '0.9rem', px: 1, mt: 1 }}
        />
      </Box>
    </Box>
  );
        ...
        <TabPanel value={tab} index={3}>
          {pollingStatus ? (
            <Paper sx={{ p: 6, textAlign: 'center', bgcolor: 'rgba(30,41,59,0.7)', borderRadius: 3, border: '1px solid rgba(59,130,246,0.3)' }}>
              ...
              <Typography variant="h6" sx={{ color: '#94A3B8' }}>Gemini AI is analyzing your configuration changes...</Typography>
              ...
              <Grid item xs={12}>
                <Paper sx={{ p: 4, bgcolor: 'rgba(30,41,59,0.7)', border: '1px solid rgba(59,130,246,0.3)', borderRadius: 3 }}>
                  <Box sx={{ display: 'flex', alignItems: 'center', gap: 2, mb: 3 }}>
                    ...
                    <Typography variant="h6" sx={{ fontWeight: 700 }}>Gemini AI Executive Summary</Typography>
                    <Chip
              ...
              <Grid item xs={12} md={6}>
                <Paper sx={{ p: 3, bgcolor: 'rgba(30,41,59,0.7)', border: '1px solid rgba(255,255,255,0.08)', borderRadius: 3 }}>
                  ...
                  <Box sx={{ display: 'flex', alignItems: 'center', gap: 3 }}>
                    <Box>
                      <Typography variant="h1" sx={{ color: RISK_COLORS[riskLevel] || '#6B7280', fontWeight: 900, lineHeight: 1 }}>
