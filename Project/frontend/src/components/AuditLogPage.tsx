        ...
        <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-end', mb: 4 }}>
          <Box>
            ...
            <Typography variant="body2" sx={{ color: '#64748B' }}>
              Complete enterprise-level event trail for all system activities
            </Typography>
          </Box>
          ...
          <Box sx={{ display: 'flex', gap: 2, flexWrap: 'wrap', alignItems: 'center' }}>
            ...
            <FormControl size="small" sx={{ minWidth: 200 }}>
              ...
              >
                ...
                {uniqueEvents.map(e => <MenuItem key={e} value={e}>{e}</MenuItem>)}
              </Select>
            </FormControl>
            <Chip
                  ...
                  {filtered.map((log, i) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <TableCell sx={{ borderColor: 'rgba(255,255,255,0.03)', color: '#94A3B8', fontSize: '0.78rem', maxWidth: 260 }}>
                          <Typography noWrap variant="caption" sx={{ color: '#94A3B8' }}>
                            {log.event_description}
                          </Typography>
                        </TableCell>
                        <TableCell sx={{ borderColor: 'rgba(255,255,255,0.03)', color: '#64748B', fontSize: '0.75rem' }}>
                          {log.user_email || '—'}
                        </TableCell>
                        <TableCell sx={{ borderColor: 'rgba(255,255,255,0.03)' }}>
                          <Chip
                            label={(log.user_role || 'UNKNOWN').toUpperCase()}
                            size="small"
                            sx={{ bgcolor: 'rgba(139,92,246,0.1)', color: '#8B5CF6', fontSize: '0.6rem', fontWeight: 700, height: 18 }}
                          />
                        </TableCell>
                        <TableCell sx={{ borderColor: 'rgba(255,255,255,0.03)', color: '#475569', fontSize: '0.72rem', whiteSpace: 'nowrap' }}>
